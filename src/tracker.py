...
class KCFTracker:
    ...
    def update(self, image, threshold=0.4, cut_aspect_ratio=1.5):
        ...
        try:
            ...
            if peak_value < threshold or self._roi[3] / self._roi[2] > cut_aspect_ratio or self._roi[2] / self._roi[3] > cut_aspect_ratio:
